    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-lg-10 offset-lg-1 mb-4">
                ...
                <div class="hero__content"><?=get_field('content')?></div>
            ...
            if ( get_field('show_hippa_badge') != 'No' ) {
                ?>
            <div class="col-12">
                <div class="hippa-badge <?=$hippa_class?>" style="background-image:url(<?=get_stylesheet_directory_uri()?>/img/hippa-compliant.png)"></div>
            </div>
                <?php
            }
            ?>
