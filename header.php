...
<div class="site" id="page">
    <nav id="main-nav" class="fixed-top navbar navbar-expand-lg d-block px-0 py-3" aria-labelledby="main-nav-label">
        <div class="container-xl d-flex justify-content-between">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle navigation', 'understrap' ); ?>"><i class="fa fa-navicon"></i></button>
            <?php
                wp_nav_menu(
                    array(
            ...
            <div class="d-none d-lg-inline">
                <a href="#" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/rxmile/30min' });return false;" class="btn-navbar--outline me-2">Book Demo</a>
