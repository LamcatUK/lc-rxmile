  ...
  function requireComponentFunctions() {
    ...
    (function (module, exports) {
      (function (global, factory) {
        ...
        componentFunctions,
        function (exports, EventHandler, SelectorEngine, index_js) {
          /**
           * --------------------------------------------------------------------------
  ...
  function requireCollapse() {
    ...
    (function (module, exports) {
      (function (global, factory) {
        ...
        collapse$1,
        function (BaseComponent, EventHandler, SelectorEngine, index_js) {
          /**
           * --------------------------------------------------------------------------
    ...
    (function (module, exports) {
      (function (global, factory) {
        ...
        function (
          ...
          const PLACEMENT_BOTTOM = index_js.isRTL()
            ? "bottom-end"
            : "bottom-start";
          const PLACEMENT_BOTTOMEND = index_js.isRTL()
            ? "bottom-start"
            : "bottom-end";
          const PLACEMENT_RIGHT = index_js.isRTL()
            ? "left-start"
            : "right-start";
          const PLACEMENT_LEFT = index_js.isRTL()
            ? "right-start"
            : "left-start";
  ...
  function requireTemplateFactory() {
    ...
    (function (module, exports) {
      (function (global, factory) {
        ...
        templateFactory,
        function (SelectorEngine, Config, sanitizer_js, index_js) {
          /**
           * --------------------------------------------------------------------------
        ...
        function (BaseComponent, EventHandler, SelectorEngine, index_js) {
          ...
          class ScrollSpy extends BaseComponent {
            ...
            _configAfterMerge(config) {
              ...
              config.target =
                index_js.getElement(config.target) || document.body;
